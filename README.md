...
Да, если у вас несколько Remnanode в проекте, установите скрипт на каждую из них, чтобы блокировать IP на каждой из них.

Если хотите использовать Webhook - укажите название локации при установке, которое будет отправляться в payload.
